...
export const Manufacturing: React.FC = () => {
  return (
    <>
      <PageMeta 
        title="Manufacturing Facility & Process" 
        description="Explore our 45,000 sq. ft. ISO 9001 certified GRP manufacturing facility in Mysuru. We offer vertical integration from raw material compounding to final assembly."
      />
